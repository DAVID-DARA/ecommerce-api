...
//Project Classes
import com.project.ecommerce_api.entities.*;
...
import com.project.ecommerce_api.repositories.*;
...
//    private void invalidateToken(User currentUser, TokenType tokenType) {
//        List<Token> allTokenOfTypeForCurrentUser = tokenRepository.findByUserAndType(currentUser, tokenType);
//        for (Token currentToken: allTokenOfTypeForCurrentUser) {
//            currentToken.setIsUsed(true);
//            try {
//                tokenRepository.save(currentToken);
//            } catch (Exception e) {
//                logger.error("Error updating otp, invalidateToken(AuthenticationService.java)", e);
//                throw new CustomException("Error sending new otp", "500");
//            }
//        }
//    }
